...
export default function AccesoriosAlertCard({
  ...
  return (
    <div className="max-w-3xl w-full mx-auto bg-gradient-to-r from-orange-50 to-violet-50 rounded-xl shadow-md border border-orange-200 p-4 text-center">
      <div className="flex flex-col items-center gap-2">
        ...
        <Link
          href={href}
          className="mt-2 px-4 py-2 bg-orange-500 text-white text-sm font-semibold rounded-xl hover:bg-orange-600 transition-colors focus:outline-none focus:ring-2 focus:ring-orange-500/60 focus:ring-offset-2"
        >
          {buttonText}
        </Link>
      </div>
